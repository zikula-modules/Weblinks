...
function Weblinks_pntables()
{
    ...
    $pntable['weblinks_categories'] = DBUtil::getLimitedTablename('weblinks_categories');
    $pntable['weblinks_categories_column']     = array ('cat_id'       => 'pn_cat_id',
                                                        'parent_id'    => 'pn_parent_id',
                                                        'title'        => 'pn_title',
                                                        'cdescription' => 'pn_description');
    $pntable['weblinks_categories_column_def'] = array ('cat_id'       => 'I AUTO PRIMARY',
                                                        'parent_id'    => 'I DEFAULT NULL',
                                                        'title'        => "C(50) NOTNULL DEFAULT ''",
                                                        'cdescription' => "X NOTNULL DEFAULT ''");

    $pntable['weblinks_links'] = DBUtil::getLimitedTablename('weblinks_links');
    $pntable['weblinks_links_column']     = array ('lid'               => 'pn_lid',
                                                   'cat_id'            => 'pn_cat_id',
                                                   'title'             => 'pn_title',
                                                   'url'               => 'pn_url',
    ...
    $pntable['weblinks_links_column_def'] = array ('lid'               => 'I AUTO PRIMARY',
    ...
    $pntable['weblinks_modrequest'] = DBUtil::getLimitedTablename('weblinks_modrequest');
    $pntable['weblinks_modrequest_column']     = array ('requestid'       => 'pn_requestid',
                                                        'lid'             => 'pn_lid',
                                                        'cat_id'          => 'pn_cat_id',
                                                        'sid'             => 'pn_sid',
                                                        'title'           => 'pn_title',
    ...
    $pntable['weblinks_modrequest_column_def'] = array ('requestid'       => 'I AUTO PRIMARY',
    ...
    $pntable['weblinks_newlink'] = DBUtil::getLimitedTablename('weblinks_newlink');
    $pntable['weblinks_newlink_column']     = array ('lid'         => 'pn_lid',
                                                     'cat_id'      => 'pn_cat_id',
                                                     'title'       => 'pn_title',
                                                     'url'         => 'pn_url',
                                                     'description' => 'pn_description',
                                                     ...
                                                     'email'       => 'pn_email',
                                                     'submitter'   => 'pn_submitter');
    $pntable['weblinks_newlink_column_def'] = array ('lid'         => 'I AUTO PRIMARY',
                                                     'cat_id'      => "I NOTNULL DEFAULT '0'",
                                                     'title'       => "C(100) NOTNULL DEFAULT ''",
                                                     'url'         => "C(254) NOTNULL DEFAULT ''",
                                                     'description' => "X NOTNULL DEFAULT ''",
    ...
    $pntable['weblinks_votedata'] = DBUtil::getLimitedTablename('weblinks_votedata');
    $pntable['weblinks_votedata_column']     = array ('ratingdbid'      => 'pn_id',
                                                      'ratinglid'       => 'pn_lid',
                                                      'ratinguser'      => 'pn_user',
                                                      'rating'          => 'pn_rating',
    ...
    $pntable['weblinks_votedata_column_def'] = array ('ratingdbid'      => 'I AUTO PRIMARY',

...
function Weblinks_user_view() // ready
{
    ...
    $render->assign('helper', array('main' => 1));
...
function Weblinks_user_category() // ready
{
    ...
    $render->assign('helper', array('main' => 0, 'showcat' => 0, 'details' => 0));
    $render->assign('tb', pnModGetVar('Weblinks', 'targetblank'));
...
function Weblinks_user_search() // ready
{
    ...
    $render->assign('weblinks', $weblinks);
    $render->assign('helper', array('main' => 0, 'showcat' => 1, 'details' => 0));
    $render->assign('tb', pnModGetVar('Weblinks', 'targetblank'));
...
function Weblinks_user_viewlinkdetails() // ready
{
    ...
    $render->assign('helper', array('main' => 0, 'showcat' => 1, 'details' => 1));
    if (pnModGetVar('Weblinks', 'websnaprkey') == 1) {
        $render->assign('websnapr', pnModGetVar('Weblinks', 'websnapr'));
        $render->assign('websnaprkey', pnModGetVar('Weblinks', 'websnaprkey'));
        $render->assign('websnaprsize', pnModGetVar('Weblinks', 'websnaprsize'));
...
function Weblinks_user_newlinks() // ready
{
    ...
    $render->assign('helper', array('main' => 0));

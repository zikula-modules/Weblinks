...
class Weblinks_Controller_Admin extends Zikula_AbstractController {
    ...
    */
    public function view()
    {
        ...
        return $this->view->fetch('weblinks_admin_view.html');
    }
    ...
    */
    public function catview()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_catview.html');
    }
    ...
    */
    public function modcategory()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_modcategory.html');
    }
    ...
    */
    public function suredelcategory()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_suredelcategory.html');
    }
    ...
    */
    public function linkview()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_linkview.html');
    }
    ...
    */
    public function modlink()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_modlink.html');
    }
    ...
    */
    public function validate()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_validate.html');
    }
    ...
    */
    public function listbrokenlinks()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_listbrokenlinks.html');
    }
    ...
    */
    public function listmodrequests()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_listmodrequests.html');
    }
    ...
    */
    public function getconfig()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_getconfig.html');
    }
    ...
    */
    public function help()
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_help.html');
    }
    ...
    */
    public function import() // ready
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('weblinks_admin_import.html');
    }
    ...
    */
    public function importratings()
    {
        ...
        foreach ($votes as $v) {
            ...
            if (!DBUtil::insertObject($obj, 'ratings')) return LogUtil::registerError($this->__('Error inserting votes in ratings table.'));
            $counter++;
        }
    ...
    */
    public function importezcomments()
    {
        ...
        foreach ($comments as $c) {
            ...
            if (!DBUtil::insertObject($obj, 'EZComments')) return LogUtil::registerError($this->__('Error inserting comments in ezcomments table.'));
            $counter++;
        }
    ...
    */
    ...
    //     $categories = DBUtil::selectObjectArray('cmodsweblinks_categories', '', 'cat_id', '-1', '-1');
        ...
        foreach ($categories as $category) {
            ...
            if (!DBUtil::insertObject($obj, 'links_categories', 'cat_id')) return LogUtil::registerError($this->__('Error inserting CmodsWebLinks categories in Weblinks categories table.'));
    ...
    //    $links = DBUtil::selectObjectArray('cmodsweblinks_links', '', 'lid', '-1', '-1');
        ...
        foreach ($links as $link) {
            ...
            if (!DBUtil::insertObject($obj, 'links_links', 'lid')) return LogUtil::registerError($this->__('Error inserting CmodsWebLinks links in Weblinks links table.'));
    ...
    //    $modrequests = DBUtil::selectObjectArray('cmodsweblinks_modrequest', '', 'requestid', '-1', '-1');
        ...
        foreach ($modrequests as $modrequest) {
            ...
            if (!DBUtil::insertObject($obj, 'links_modrequest', 'requestid')) return LogUtil::registerError($this->__('Error inserting CmodsWebLinks modrequests in Weblinks modrequests table.'));
            $counter++;
        }
    ...
    //    $newlinks = DBUtil::selectObjectArray('cmodsweblinks_newlink', '', 'lid', '-1', '-1');
        ...
        foreach ($newlinks as $newlink) {
            ...
            if (!DBUtil::insertObject($obj, 'links_newlink', 'lid')) return LogUtil::registerError($this->__('Error inserting CmodsWebLinks newlinks in Weblinks newlinks table.'));
            $counter++;
        }

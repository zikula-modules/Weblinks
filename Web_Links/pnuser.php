...
function Web_Links_user_view() //ready
{
    ...
    $pnRender->assign('blocklast', pnBlockShow('Web_Links', 'lastweblinks'));
    $pnRender->assign('blockmostpop', pnBlockShow('Web_Links', 'mostpopularweblinks'));
...
function Web_Links_user_category($args)
{
    ...
    $pnRender->assign('pager', array('numitems' => pnModAPIFunc('Web_Links', 'user', 'countcatlinks', array('cid' => $cid)),
...
function Web_Links_user_modifylinkrequests($args)
{
    ...
    if (pnModGetVar('Web_Links', 'blockunregmodify') == 0 || SecurityUtil::checkPermission('Web_Links::', '::', ACCESS_COMMENT)) {
        ...
        LogUtil::registerError (_WL_ONLYREGUSERSMODIFY);

...
function Weblinks_admin_view() // ready
{
    ...
    $render->assign('totalbrokenlinks', ModUtil::apiFunc('Weblinks', 'admin', 'countbrokenlinks'));
    $render->assign('totalmodrequests', ModUtil::apiFunc('Weblinks', 'admin', 'countmodrequests'));
    $render->assign('newlinks', ModUtil::apiFunc('Weblinks', 'admin', 'newlinks'));
...
function Weblinks_admin_modcategory() // ready
{
    ...
    // assign various useful template variables
    $render->assign('authid', SecurityUtil::generateAuthKey('Weblinks'));
    $render->assign('category', ModUtil::apiFunc('Weblinks', 'admin', 'getcategory', array('cid' => $cid)));
        ...
        if ($addlink == true) {
            if ($link['new'] == 1) {
                ...
                if ($link['email'] == "") {
                    ...
                    .DataUtil::formatForDisplay(__('The site\'s search engine is available at:', $dom)). "<br /><a href=\"" .System::getBaseUrl() . "index.php?module=Weblinks\">" .System::getBaseUrl() . "index.php?module=Weblinks</a><br /><br />"
...
function Weblinks_admin_listbrokenlinks() // ready
{
    ...
    $render->assign('authid', SecurityUtil::generateAuthKey('Weblinks'));
    $render->assign('totalbrokenlinks', ModUtil::apiFunc('Weblinks', 'admin', 'countbrokenlinks'));
    $render->assign('brokenlinks', ModUtil::apiFunc('Weblinks', 'admin', 'brokenlinks'));
...
function Weblinks_admin_listmodrequests() // ready
{
    ...
    $render->assign('authid', SecurityUtil::generateAuthKey('Weblinks'));
    $render->assign('totalmodrequests', ModUtil::apiFunc('Weblinks', 'admin', 'countmodrequests'));
    $render->assign('modrequests', ModUtil::apiFunc('Weblinks', 'admin', 'modrequests'));
...
function Weblinks_admin_getconfig() // ready
{
    ...
    // assign various useful template variables
    $render->assign('authid', SecurityUtil::generateAuthKey('Weblinks'));
    $render->assign('config', ModUtil::getVar('Weblinks'));
